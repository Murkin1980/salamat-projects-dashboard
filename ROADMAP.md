...
9. CP-08 Cloudflare Production — PASS / automatic main deployment extension — VALIDATION (workflow configured; repository secrets + first production run pending)
...
12. CP-11 Portfolio Refresh — VALIDATION
